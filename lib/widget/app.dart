  ...
  Widget build(BuildContext context) {
   return MaterialApp(
     ...
     routes: <String,WidgetBuilder>{
       '/urlProfile':(BuildContext context) => widgetProfile.Profiles(),
     },
   );
  }
    ...
    return Scaffold(
      ...
      body: new TabBarView(
          ...
          children: <Widget>[
            ...
            new widgetSallary.Sallary(),
          ]
      ),

      //BOTTOM NAVIGATION BAR
      bottomNavigationBar: new Material(
        color: appConfig.color.ColorPrimaryDark,
        child: TabBar(
          controller: controller,
          tabs: <Widget>[
            new Tab(
            ...
            new Tab(
              icon: new Icon(appConfig.icons.icon_attendence),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        backgroundColor: appConfig.color.ColorButton,
      ),
